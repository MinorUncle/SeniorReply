...
{
    // 2.列表
    StoreListController *msg = [[StoreListController alloc] init];
    [self addChildViewController:msg];
    

    // 1.分页
    StoreMapController *home = [[StoreMapController alloc] init];
    [self addChildViewController:home];
    
    //收藏
    StoreCollectController *collect = [[StoreCollectController alloc]init];
